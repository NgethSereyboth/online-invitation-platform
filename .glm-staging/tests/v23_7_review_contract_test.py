...
js=(ROOT / "src" / "js" / "review-v23.js").read_text(encoding='utf-8');css=(ROOT / "src" / "css" / "organized" / "review-v23.css").read_text(encoding='utf-8');loader=(ROOT / "src" / "js" / "performance-loader-v22.js").read_text(encoding='utf-8');server=(ROOT/'src'/'python'/'server.py').read_text(encoding='utf-8');pg=(ROOT/'docs'/'postgres_schema.sql').read_text(encoding='utf-8')
