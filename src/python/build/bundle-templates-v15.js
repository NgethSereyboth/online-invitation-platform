...
function toast(message,icon='✦'){
  ...
  const msgEl=document.createElement('b');msgEl.textContent=String(message??'');
  t.append(iconEl,msgEl);stack.append(t);setTimeout(()=>{t.classList.add('out');setTimeout(()=>t.remove(),220)},1900)
}
