...
function toast(message,icon='✦'){
  ...
  const t=document.createElement('div');t.className='final-toast';const iconEl=document.createElement('span');iconEl.textContent=String(icon??'');const msgEl=document.createElement('b');msgEl.textContent=String(message??'');t.append(iconEl,msgEl);stack.append(t);setTimeout(()=>{t.classList.add('out');setTimeout(()=>t.remove(),220)},1900)
}
