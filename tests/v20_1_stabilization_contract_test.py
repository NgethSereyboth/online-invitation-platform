...
ROOT=Path(__file__).resolve().parents[1];sys.path.insert(0,str(ROOT));sys.path.insert(0,str(ROOT/'src'/'python'))
...
def main():
 contract=json.loads((ROOT / "docs" / "typography-contract.json").read_text(encoding='utf-8'))
 ...
 dashboard=(ROOT / "src" / "js" / "dashboard.js").read_text(encoding='utf-8')
 ...
 polish=(ROOT / "src" / "js" / "final-polish.js").read_text(encoding='utf-8');assert "!art.closest('.invite-card')" in polish
 ...
 editor=(ROOT / "src" / "js" / "typography-editor-v20.js").read_text(encoding='utf-8');refresh=editor[editor.index('function refresh()'):]
