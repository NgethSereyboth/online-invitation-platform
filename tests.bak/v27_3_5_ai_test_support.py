...
def load_full_ai(page):
 page.add_style_tag(content=(ROOT / "src" / "css" / "ai-assistant-pro.css").read_text(encoding='utf-8'))
 page.add_script_tag(content=(ROOT / "src" / "js" / "ai-assistant-pro.js").read_text(encoding='utf-8'))
