...
with sync_playwright() as p:
 ...
 for name,vp in [('desktop',{'width':1440,'height':1000}),('mobile',{'width':430,'height':900})]:
  ...
  q.add_style_tag(content=(ROOT / "src" / "css" / "page-experience-v22.css").read_text());q.add_script_tag(content=(ROOT / "src" / "js" / "page-experience-v22.js").read_text());q.wait_for_function("()=>EInvitePageExperience?.version==='22.2.8'")
