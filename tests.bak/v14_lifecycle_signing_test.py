...
def run(code,data,extra=None):
 ...
 return subprocess.run([sys.executable,'-c',code],cwd=ROOT/'src'/'python',env=env,text=True,encoding='utf-8',errors='replace',stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
