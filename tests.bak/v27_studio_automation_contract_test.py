...
def run():
 server=(ROOT/'src'/'python'/'server.py').read_text(encoding='utf-8');js=(ROOT / "src" / "js" / "studio-automation-v27.js").read_text(encoding='utf-8');css=(ROOT / "src" / "css" / "studio-automation-v27.css").read_text(encoding='utf-8');loader=(ROOT / "src" / "js" / "performance-loader-v22.js").read_text(encoding='utf-8');schema=(ROOT/'docs'/'postgres_schema.sql').read_text(encoding='utf-8')
