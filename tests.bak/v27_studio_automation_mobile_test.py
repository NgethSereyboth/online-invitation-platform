...
def main()->int:
 ...
 with sync_playwright() as p:
  ...
  page.add_style_tag(path=str(ROOT / "src" / "css" / "studio-automation-v27.css"))
  ...
  page.add_script_tag(path=str(ROOT / "src" / "js" / "studio-automation-v27.js"));page.wait_for_timeout(150);page.evaluate("()=>EInviteStudioAutomation.open('remediation')");page.wait_for_timeout(150)
