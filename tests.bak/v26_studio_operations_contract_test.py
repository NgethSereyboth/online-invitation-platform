...
client=(ROOT / "src" / "js" / "studio-operations-v26.js").read_text()
...
assert 'requireStudioRelease' in server and 'requireStudioRelease' in (ROOT / "src" / "js" / "studio-governance-v25.js").read_text()
