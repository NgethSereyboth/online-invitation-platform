...
spec=json.loads((ROOT / "docs" / "route-bundle-sources-v15.json").read_text(encoding='utf-8'))['pages']['public.html']
...
source=(ROOT / "src" / "js" / "guest-journey.js").read_text(encoding='utf-8')
...
assert 'EInviteGuestJourney?.enhance(root,d)' in (ROOT / "src" / "js" / "public-page.js").read_text(encoding='utf-8')
