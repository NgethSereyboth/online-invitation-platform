...
js = (ROOT / "src" / "js" / "workflow-continuity.js").read_text(encoding='utf-8')
css = (ROOT / "src" / "css" / "organized" / "workflow-continuity.css").read_text(encoding='utf-8')
legacy = (ROOT / "src" / "js" / "workflow-refine.js").read_text(encoding='utf-8')
