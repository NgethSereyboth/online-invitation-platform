...
def main()->int:
 ...
 with sync_playwright() as p:
  ...
  page.add_script_tag(path=str(ROOT / "src" / "js" / "workflow-creation-flow-v4.js"));page.wait_for_timeout(80)
  assert page.locator('#workflowPageDock').count()==1
  assert page.locator('#workflowPageDock .workflow-page-add').count()==1
  ...
  page.add_style_tag(path=str(ROOT / "src" / "css" / "organized" / "review-v23.css"));page.add_script_tag(path=str(ROOT / "src" / "js" / "review-v23.js"));page.wait_for_timeout(180)
