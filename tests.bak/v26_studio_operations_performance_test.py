...
def main()->int:
 ...
 with sync_playwright() as p:
  ...
  page.add_style_tag(path=str(ROOT / "src" / "css" / "studio-operations-v26.css"))
  ...
  start=page.evaluate('performance.now()');page.add_script_tag(path=str(ROOT / "src" / "js" / "studio-operations-v26.js"));page.wait_for_timeout(80);page.evaluate("()=>EInviteStudioOperations.open('releases')");page.wait_for_timeout(70);elapsed=page.evaluate('(s)=>performance.now()-s',start)
