...
required = {
    ...
    "docs/FIRST_TIME_INSTALL_AND_HOSTING.md",
...
windows_setup = (ROOT / "scripts" / "setup-einvite-complete.ps1").read_text(encoding="utf-8")
...
guide = (ROOT / "docs" / "FIRST_TIME_INSTALL_AND_HOSTING.md").read_text(encoding="utf-8")
