...
js=(ROOT / "src" / "js" / "navigation-history-v23.js").read_text(encoding='utf-8')
css=(ROOT / "src" / "css" / "navigation-history-v23.css").read_text(encoding='utf-8')
loader=(ROOT / "src" / "js" / "professional-workflow-loader-v23.js").read_text(encoding='utf-8')
