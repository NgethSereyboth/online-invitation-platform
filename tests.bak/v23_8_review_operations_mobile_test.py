...
def main():
 ...
 with sync_playwright() as p:
  ...
  page.add_style_tag(path=str(ROOT / "src" / "css" / "organized" / "review-v23.css"))
  ...
  page.add_script_tag(path=str(ROOT / "src" / "js" / "review-v23.js"));page.wait_for_timeout(180);page.evaluate("()=>EInviteReviewWorkflow.open('approvals')");page.wait_for_timeout(300)
