...
class PlatformConfig:
    ...
    def capabilities(self) -> dict:
        return {"professionalLayers":self.feature_v29,"rasterWorkspace":self.feature_v30,"crdtCollaboration":self.feature_v31,"productionPlatform":self.feature_v32,"objectStorageProvider":self.object_storage_provider,"queueProvider":self.queue_provider,"collaborationProvider":self.collaboration_provider,"backupProvider":self.backup_provider,"maintenanceMode":self.maintenance_mode,"collabV52DualWrite":self.collab_v52_dualwrite}
